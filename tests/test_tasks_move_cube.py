...
class TestMoveCube(unittest.TestCase):
    ...
    def test_sample_goal_difficulty_1_with_initial_pose(self):
        for i in range(1000):
            ...
            goal = move_cube.sample_goal(
                difficulty=1, current_pose=initial_pose,
            )
    ...
    def test_sample_goal_difficulty_2_with_initial_pose(self):
        for i in range(1000):
            initial_pose = move_cube.sample_goal(-1)
            goal = move_cube.sample_goal(
                difficulty=2, current_pose=initial_pose
            )
    ...
    def test_sample_goal_difficulty_3_with_initial_pose(self):
        for i in range(1000):
            initial_pose = move_cube.sample_goal(-1)
            goal = move_cube.sample_goal(
                difficulty=3, current_pose=initial_pose
            )
    ...
    def test_sample_goal_difficulty_4_no_initial_pose(self):
        for i in range(1000):
            ...
            rx, ry, rz = Rotation.from_quat(goal.orientation).as_euler("xyz")
            self.assertEqual(rx, 0)
            self.assertEqual(ry, 0)

    def test_sample_goal_difficulty_4_with_initial_pose(self):
        for i in range(1000):
            initial_pose = move_cube.sample_goal(-1)
            goal = move_cube.sample_goal(
                difficulty=4, current_pose=initial_pose
            )
