...
import os
import sys
sys.path.insert(0, os.path.abspath('../python/trifinger_simulation'))
...
htmlhelp_basename = "pyBulletSimulationforFingerRobotsdoc"
...
latex_documents = [
    (
        master_doc,
        "pyBulletSimulationforFingerRobots.tex",
        "pyBullet Simulation for Finger Robots Documentation",
...
man_pages = [
    (
        master_doc,
        "pybulletsimulationforfingerrobots",
        "pyBullet Simulation for Finger Robots Documentation",
        [author],
        1,
    )
